...
class Products {
  List<Product> _products = [
    Product(
      title: 'Mask',
      description:
          'Made of KN95 grade particulates and new PP non-woven fabric. It filters %98 of particuls.',
    ...
    Product(
      title: 'Pro-Vac Venco',
      description:
          'A COVID-19 vaccine manufacturing plant of the institute in Kumming, capital city Yunnan Province, will be put into use in the second half of 2020',
